...
- Open items (promoted to BACKLOG.md 2026-07-26): percentage (log) boxes for pnf/renko over long histories; high/low-based pnf (`method=`); configurable renko `reversal=`. The proto notebooks deliberately keep their local copies — protos are frozen design artifacts, not maintained examples.
