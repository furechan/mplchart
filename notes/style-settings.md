...
- **Revised 2026-07-27 — category mapping reinstated as key aliases** (design: [key-aliases.md](key-aliases.md); not yet implemented). Two things changed since the rejection above, both new information rather than a change of taste:
