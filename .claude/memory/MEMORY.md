...
- [Style system record](project-style-system.md) — implemented: Style spec + Styler + settings doctrine (roles never instances, params-only validation, total styles, rejected registry/CN hacks); design notes in notes/styler-sketch.md + styler-settings.md
