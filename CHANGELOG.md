...
- Chart export tutorial reframed around the user goal ("Exporting charts to SVG and PNG"): explains the inline display format setup, adds a save-to-file example
